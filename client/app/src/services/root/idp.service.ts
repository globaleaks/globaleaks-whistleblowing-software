...
export class IdpService {
  ...
  private configure(context: IdpContext, storagePrefix: string) {
    ...
    this.oauthService.configure({
      ...
      // The IdP is required to be reached via HTTPS; plain HTTP is accepted
      // only towards the loopback interface, mirroring the backend, so that
      // a local IdP can be used on development and testing setups
