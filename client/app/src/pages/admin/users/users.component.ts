...
export class UsersComponent {
  ...
  // On a profile the accounts of the sites are composed through the profiles
  // alone: what is composed there is named by what it becomes on the sites
  protected get profilesTabTitle(): string {
    return this.isTenant ? "Profiles" : "Users";
  }
}
