...
@Component({
    ...
    standalone: true,
    imports: [TabsComponent, TabDirective, FormsModule, Tab1Component, Tab2Component, Tab3Component, Tab4Component, Tab6Component, Tab8Component]
})
export class AdminSettingsComponent {
  ...
  // The backup feature is configurable on the primary tenant only: its tab is
  // hidden on secondary tenants and profiles
  protected get isBackupConfigurable(): boolean {
