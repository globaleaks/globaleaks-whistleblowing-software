import {SearchDashboardConfigComponent} from "./search-dashboard/search-dashboard.component";
...
@Component({
    ...
    standalone: true,
    imports: [SearchDashboardConfigComponent, TabsComponent, TabDirective, FormsModule, CaseManagementTab1Component]
})
