...
export class TipsComponent implements OnInit {
  ...
  openLogsModal() {
    this.httpService
     .requestRecipientTipsAuditLogResource()
     .subscribe((auditLogsByTip) => {
       const modalRef = this.modalService.open(TipAuditLogComponent, {
         size: 'xl',
         backdrop: 'static',
         keyboard: false
       });
       modalRef.componentInstance.auditLogsByTip = auditLogsByTip;
       modalRef.componentInstance.usersData = [this.preferencesService.dataModel];
       modalRef.componentInstance.userData = this.preferencesService.dataModel;
       modalRef.componentInstance.name = 'tips_list';
    });
  }
