...
@Component({
    ...
    standalone: true,
    imports: [StatisticalReportEditorComponent, FormsModule, NgbTooltipModule, NgClass, DatePipe, DateRangeSelectorComponent, NgMultiSelectDropDownModule, PaginatedInterfaceComponent, TranslatorPipe]
})
