...
class Test_OIDCAuth(helpers.TestGL):
    def setUp(self):
        ...
        # OIDC metadata
        self.issuer = "http://localhost:9090/realms/globaleaks"
    ...
    def test_validate_token(self):
        ...
        self.oidc.jwks = {"keys": [jwk_key]}

        self.oidc.verify_token(valid_token)
    ...
    def test_invalid_token_format(self):
        ...
        self.assertRaises(JWTError, self.oidc.verify_token, invalid_token)
    ...
    def test_no_key_in_jwks(self):
        ...
        self.oidc.jwks = {"keys": [{"kid": "other-key-id", "alg": "RS256", "use": "sig"}]}

        self.assertRaises(Exception, self.oidc.verify_token, valid_token)
    ...
    def test_expired_signature(self):
        ...
        self.assertRaises(ExpiredSignatureError, self.oidc.verify_token, expired_token)
