...
ConfigDescriptor = {
    ...
    'enable_forward_in': Bool(default=False),
    'enable_forward_out': Bool(default=False),
    'accept_forwarding': Bool(default=False),
    'accept_forwarding_from': List(default=[]),
    'accepts_requests_of_forward_from': List(default=[]),
    'send_forwarding': List(default=[]),
    'send_forwarding_request': List(default=[]),
    'forward_filter': List(default=[]),
    'forward_questionnaire': Unicode(default='forward'),
...
ConfigFilters = {
    'node': [
        ...
        'accepts_requests_of_forward_from',
        'send_forwarding',
        'send_forwarding_request',
        'forward_filter',
