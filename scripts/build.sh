...
TARGETS="bookworm jammy noble resolute trixie"
DISTRIBUTION="trixie"
TAG="stable"
LOCAL_ENV=0
NOSIGN=0
...
usage() {
  ...
  echo -e " -d distribution (available: bookworm, jammy, noble, resolute, trixie)"
...
case "$DISTRIBUTION" in
  bookworm|jammy|noble|resolute|trixie|all) ;;
  *) usage; exit 1 ;;
esac
